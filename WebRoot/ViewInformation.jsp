   			...
   			<div class="content">
   				...
   				<div class="func">
   					<div class="detailInfo">
						<div class="item"><label>帐&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号:&nbsp;<%=user.getUid() %></label></div>
						<div class="item"><label>性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别:&nbsp;<%=gender %></label></div>
						<div class="item"><label>电&nbsp;&nbsp;子&nbsp;&nbsp;邮&nbsp;&nbsp;箱:&nbsp;<%=user.getEmail() %></label></div>
						<div class="item"><label>密码提示问题:&nbsp;<%=user.getQuestion() %></label></div>
						<div class="item"><label>密码提示答案:&nbsp;<%=user.getAnswer() %></label></div>
						<div class="item"><label>真&nbsp;&nbsp;实&nbsp;&nbsp;姓&nbsp;&nbsp;名:&nbsp;<%=user.getRealName() %></label></div>
						<div class="item"><label>联&nbsp;&nbsp;系&nbsp;&nbsp;电&nbsp;&nbsp;话:&nbsp;<%=user.getTel() %></label></div>
						<div class="item"><label>账&nbsp;&nbsp;户&nbsp;&nbsp;余&nbsp;&nbsp;额:&nbsp;<%=user.getMoney() %></label></div>
						<div class="item">
						<%String path="EditInformation.jsp?uid="+uid+"&editUid="+uid; %>
							<input class="editBtn" type=button name="editBtn" value="" onclick=<%="javascript:window.location=\'"+path+"\'"%> />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input class="backBtn" type=button name="backBtn" value="" onclick=<%="javascript:window.location=\'"+"UserIndex.jsp?uid="+uid+"\'" %> />
						</div>														
   					</div>  					 					
   				</div>
   			</div>
