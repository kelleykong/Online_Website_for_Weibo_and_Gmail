			...
			.logo{positon:relative;left:100px;top:100px}
				...
				.content{width:1000px;height:400px;margin:0 auto}
					...
					.func{float:right;width:750px;height:400px;margin-right:14px}
						...
						.func .mesList .item .ipt-t{vertical-align:middle;border:1px solid #878787;font-size:14px;font-weight:bold;padding:6px 0px;width:330px}
						...
						.func .mesList .con .ipt-t{height:130px;vertical-align:middle;border:1px solid #878787;font-size:14px;font-weight:bold;padding:6px 0px;width:330px}
						.subBtn{background:url(res/mesSendbtn.png);background-repeat:no-repeat}			
	...
	<body>
    	...
    	<div class="container"> 		
   			...
   			<div class="content">
   				...
   				<div class="func">
   					<img class="navi" src="res/sendMesNavi.png" border="0" usemap="#mesNavi" />
   					...
   					<form class="mesList" name="SendMessageForm" method="post" action="SendMessage">
   						<div class="item">
   							<label class="name">主&nbsp;&nbsp;&nbsp;题：</label>
   							<input name=messageName type=text id=uid size=20 maxlength=50 class="ipt-t">   														
   						</div>
   						<div class="item">
   							<label class="name">收件人：</label>
   							<input name=receiver type=text id=uid size=20 maxlength=50 class="ipt-t" />
   						</div>	
   						<div class="con">
   							<label class="name">内&nbsp;&nbsp;&nbsp;容：</label>
   							<input name=messageContent type=text id=uid size=50 maxlength=200 class="ipt-t">
   						</div>
						<div class="item">
   						...
   						<div class="item">
   							<input name=sender type=hidden id=uid value=<%=userUid %> class="ipt-t" />
   						</div>						   						
   					</form>
   				</div>
   			</div>
